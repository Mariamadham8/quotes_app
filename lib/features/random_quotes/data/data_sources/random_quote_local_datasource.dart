...
class RandomQuoteLocalDatasourceImpl implements RandomQuoteLocalDatasource{
  ...
  @override
  Future<void> cacheQuote(QuoteModel quote) {
    return sharedPreferences.setString(Constants.chechedRandomQuote, json.encode(quote));
  }

  @override
  Future<QuoteModel> getLastRandomQuote() {
      final jsonString = sharedPreferences.getString(Constants.chechedRandomQuote);
      if(jsonString !=null){
